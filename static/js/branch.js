...
branch.banner({
   ...
   description: 'FREE -  on the App Store and Google Play!',
   openAppButtonText: 'Open',              // Text to show on button if the user has the app installed
   downloadAppButtonText: 'Download',      // Text to show on button if the user does not have the app installed
   sendLinkText: 'Send Link',              // Text to show on desktop button to allow users to text themselves the app
   showiOS: false,                          // Should the banner be shown on iOS devices?
   ...
   customCSS: '.title { color: #fff; } #branch-mobile-action, #branch-mobile-action:hover{ border-bottom: 3px solid #0082b2; background-color: #30baed; padding: 5px; border-radius: 3px;}',   // Add your own custom styles to the banner that load last, and are gauranteed to take precedence, even if you leave the banner in an iframe
